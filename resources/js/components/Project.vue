                            ...
                            <tr v-for="project in arrayProject" :key="project.id">
                                <td>
                                    <div class="form-inline">
                                        ...
                                        <template v-else>
                                            <button type="button"  class="btn btn-danger btn-sm" @click="desactivarProject(project.id)" v-if="project.estado == 'Registrado'">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
        ...
        <template v-else-if="listado==2">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div :class="{'col-md-7': pagado_parcial,  'col-md-2': !pagado_parcial}">
